...
Upgrade the existing project into a feature-rich, production-ready, and professional application.
...
* Minimum 3 routes (logged out). [Example: Home, Items, About, Login]
* Minimum 5 routes (logged in). [Example: Home, Items, Dashboard, Profile (Dropdown), Logout]
...
* **Sidebar navigation:**
    * **User:** minimum 3 menu items / page [Example: Overview, My Items, Profile, Settings]
    * **Admin:** minimum 5 menu items / page [Example: Overview, Manage Users, Manage Items, Analytics, Categories]
...
* Proper error/success messages in forms.
